        ...
        <div class="flex items-center justify-between pt-6 border-t border-slate-100">
            <div>
                @if($package->price_egp)
                    <div class="text-3xl font-bold text-green-700">{{ number_format($package->price_egp, 0) }} <span class="text-base font-normal text-slate-500">{{ __('site.common.egp') }}</span></div>
                @endif
            </div>
