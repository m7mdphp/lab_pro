...
<section class="bg-gradient-to-br from-green-900 to-emerald-700 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-green-100">{{ __('site.branches.subtitle') }}</p>
    </div>
</section>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-md transition-shadow">
                    ...
                    <ul class="space-y-2 text-sm text-slate-600">
                        ...
                        @if($branch->phone)
                            <li class="flex items-center gap-2">
                                ...
                                <a href="tel:{{ $branch->phone }}" class="hover:text-green-700 transition-colors">{{ $branch->phone }}</a>
                            </li>
                        @endif
                    ...
                    @if($branch->google_maps_url)
                        <a href="{{ $branch->google_maps_url }}" target="_blank" rel="noopener"
                           class="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-green-700 hover:text-green-800">
