...
<section class="relative text-white overflow-hidden" style="min-height: 380px;">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <h1 class="page-hero-title text-4xl md:text-5xl font-extrabold mb-4 leading-tight">{{ __('site.branches.title') }}</h1>
        <p class="page-hero-subtitle text-green-100/85 text-lg max-w-2xl mx-auto leading-relaxed">{{ __('site.branches.subtitle') }}</p>
    </div>
</section>
