@php
    ...
    $address      = SiteSetting::get($isAr ? 'address_ar' : 'address_en', 'El-Sheikha Lab, Egypt');
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:{{ $hotline }}" class="text-slate-300 hover:text-green-400 transition-colors font-semibold tracking-wide">الخط الساخن: {{ $hotline }}</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-green-800/50 flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-slate-400">{{ $workingHours }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mt-2">
                    <a href="{{ $facebookUrl }}" class="w-9 h-9 rounded-lg bg-slate-800 hover:bg-green-800 flex items-center justify-center transition-colors group" aria-label="Facebook">
                    ...
                    <a href="{{ $instagramUrl }}" class="w-9 h-9 rounded-lg bg-slate-800 hover:bg-green-800 flex items-center justify-center transition-colors group" aria-label="Instagram">
                    ...
                    <a href="{{ $whatsappUrl }}" class="w-9 h-9 rounded-lg bg-slate-800 hover:bg-green-800 flex items-center justify-center transition-colors group" aria-label="WhatsApp">
