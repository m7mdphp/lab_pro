...
class PartnerResource extends Resource
{
    ...
    public static array $translatableFields = ['name', 'description', 'specialty'];
        ...
        return $form->schema([
            Forms\Components\Tabs::make('Tabs')->tabs([
                ...
                Forms\Components\Tabs\Tab::make('English')->schema([
                    ...
                    Forms\Components\TextInput::make('specialty_en')->label('Specialty (EN)')->maxLength(255),
                ...
                Forms\Components\Tabs\Tab::make('عربي')->schema([
                    ...
                    Forms\Components\TextInput::make('specialty_ar')->label('التخصص (AR)')->maxLength(255),
                ...
                Forms\Components\Tabs\Tab::make('إعدادات')->schema([
                    Forms\Components\TextInput::make('slug')
                        ...
                        ->maxLength(100),
                    Forms\Components\TextInput::make('website_url')->label('الموقع الإلكتروني')->url()->maxLength(500),
                    Forms\Components\TextInput::make('phone')->label('الهاتف')->maxLength(50),
                    Forms\Components\TextInput::make('logo_url')->label('رابط الشعار')->url()->maxLength(500),
